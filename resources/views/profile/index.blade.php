                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col d-flex align-items-center">
                                <img src="{{ asset('custom/assets/compiled/jpg/1.jpg') }}"
                                    class=" img img-thumbnail rounded-circle w-25" />
                                <div class="mx-3">
                                    <span
                                        class="font-weight-bolder font-size-h5 text-dark-75 text-hover-primary show-nama">James
                                        Jones</span>
                                    <div class="text-muted show-hak_akses">Application Developer</div>
                                </div>
                            </div>
