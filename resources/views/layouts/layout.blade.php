...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('custom/assets/compiled/svg/favicon.svg') }}" type="image/x-icon">
    ...
    <link rel="stylesheet" href="{{ asset('custom/assets/compiled/css/app-dark.css') }}">
            ...
            <footer>
                <div class="footer clearfix mb-0 text-muted">
                    <div class="float-start">
                        <p>2023 &copy; Plafound</p>
                    </div>
                    <div class="float-end">
                        <p>Made with <span class="text-danger"><i class="bi bi-heart-fill icon-mid"></i></span>
                            by <a href="https://instagram.com/suryawisnugraha">Surya Wisnugraha</a></p>
                    </div>
                </div>
            </footer>
        </div>
